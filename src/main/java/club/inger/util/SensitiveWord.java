...
public class SensitiveWord {  
    ...
    {  	sensitiveWordSet = new HashSet<String>();
        ...
        hash.clear();
       // System.out.println( "-------------------------处理敏感"+buffer.toString());
    ...
    public void InitializationWork()
    {
        ...
        try {  
           ...
           // read = new InputStreamReader(new FileInputStream(new File("G:\\框架学习\\news\\src\\CensorWords.txt")),encoding);
        ...
        //System.out.println("------------------InitializationWork");
    }  
    ...
    public static void main(String[] args){
		...
		SensitiveWord sw = new SensitiveWord("C.txt");
        ...
        System.out.println(sw.filterInfo("贱人就是好好"));
    }
}  
