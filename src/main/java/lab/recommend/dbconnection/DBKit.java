...
public class DBKit{
	...
	public static void initalize()
	{
		try
		{
			...
			arp.addMapping("news_modules", NewsModules.class);
			arp.addMapping("news_logs", NewsLogs.class);
			...
			arp.addMapping("zan", Zan.class);
			arp.addMapping("reply",Reply.class);

			//arp.addMapping("hostory", Hostory.class);
	...
	public static HashMap<String, String> getDBInfo()
	{
		...
		try
		{
			...
			//p.load(new FileInputStream("G:\\框架学习\\news\\res\\dbconfig.properties"));
			p.load(DBKit.class.getClassLoader().getResourceAsStream("dbconfig.properties"));
