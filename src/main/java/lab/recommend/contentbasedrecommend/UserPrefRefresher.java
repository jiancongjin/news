...
import lab.recommend.algorithms.JsonKit;
...
{	
	...
	private HashMap<Long,ArrayList<Long>> getBrowsedHistoryMap(){
		...
		try
		{
			List<NewsLogs> newslogsList=NewsLogs.dao.find("select * from news_logs where view_time>"+RecommendKit.getSpecificDayFormat(-1));
