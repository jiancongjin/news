 ...
 * @date 2019年4月20日 基于内容的推荐 Content-Based
 * 
...
public class ContentBasedRecommender implements RecommendAlgorithm
{
	...
	public void recommend(List<Long> users,int isFirst)
	{
		try
		{
			...
			System.out.println("cb_count"+count);
			System.out.println("cb"+users.size());
			System.out.println("CB has contributed " + Math.ceil(count*1.0/users.size()) + " recommending news on average");
